...
import org.flickit.assessment.core.application.port.out.spaceuseraccess.CreateAssessmentSpaceUserAccessPort.Param;
import org.flickit.assessment.data.jpa.users.spaceuseraccess.SpaceUserAccessJpaEntity;

@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class SpaceUserAccessMapper {

    public static SpaceUserAccessJpaEntity toJpaEntity(Param param, Long spaceId) {
