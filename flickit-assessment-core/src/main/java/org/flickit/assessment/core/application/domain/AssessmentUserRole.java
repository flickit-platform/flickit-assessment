...
public enum AssessmentUserRole {
    ...
    VIEWER(1, "Viewer", VIEWER_PERMISSIONS, REPORT_VIEWER_PERMISSIONS),
    COMMENTER(2, "Commenter", VIEWER_PERMISSIONS, COMMENTER_PERMISSIONS, REPORT_VIEWER_PERMISSIONS),
    ASSESSOR(4, "Assessor", VIEWER_PERMISSIONS, COMMENTER_PERMISSIONS, ASSESSOR_PERMISSIONS, REPORT_VIEWER_PERMISSIONS),
    MANAGER(5, "Manager", VIEWER_PERMISSIONS, COMMENTER_PERMISSIONS, ASSESSOR_PERMISSIONS, MANAGER_PERMISSIONS, REPORT_VIEWER_PERMISSIONS),
    ASSOCIATE(3, "Associate", ASSOCIATE_PERMISSIONS, REPORT_VIEWER_PERMISSIONS),
    REPORT_VIEWER(6, "ReportViewer", REPORT_VIEWER_PERMISSIONS);
