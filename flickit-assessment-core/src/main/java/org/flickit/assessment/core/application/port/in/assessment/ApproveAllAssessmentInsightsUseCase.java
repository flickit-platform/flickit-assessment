...
public interface ApproveAllAssessmentInsightsUseCase {

    void approveAllAssessmentInsights(Param param);

    @Value
    @EqualsAndHashCode(callSuper = false)
    class Param extends SelfValidating<Param> {

        @NotNull(message = APPROVE_ALL_ASSESSMENT_INSIGHTS_ASSESSMENT_ID_NOT_NULL)
        UUID assessmentId;
