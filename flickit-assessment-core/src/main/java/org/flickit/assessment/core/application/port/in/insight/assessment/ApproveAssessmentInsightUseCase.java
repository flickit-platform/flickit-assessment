...
public interface ApproveAssessmentInsightUseCase {

    void approveAssessmentInsight(Param param);

    @Value
    @EqualsAndHashCode(callSuper = false)
    class Param extends SelfValidating<Param> {

        @NotNull(message = APPROVE_ASSESSMENT_INSIGHT_ASSESSMENT_ID_NOT_NULL)
        UUID assessmentId;
