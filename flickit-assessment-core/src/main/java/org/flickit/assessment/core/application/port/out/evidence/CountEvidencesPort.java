...
public interface CountEvidencesPort {
    ...
    /**
     * Counts the number of answered questions that have evidence for a given assessment.
     *
    ...
    /**
     * Counts the number of unresolved comments for a given assessment.
     *
     * @param assessmentId the unique identifier of the assessment
    ...
    /**
     * Counts the number of answered questions that have evidence for a list the given questionnaires,
     *
     * @param assessmentId the unique identifier of the assessment
     ...
     */
    Map<Long, Integer> countAnsweredQuestionsHavingEvidence(UUID assessmentId, long kitVersionId, ArrayList<Long> questionnaireIds);

    /**
     * Counts the number of unresolved comments for the given list of questionnaire IDs.
     *
     * @param assessmentId the unique identifier of the assessment
     * @param kitVersionId the identifier of the kit version
     ...
     */
    Map<Long, Integer> countUnresolvedComments(UUID assessmentId, long kitVersionId, ArrayList<Long> questionnaireIds);
}
