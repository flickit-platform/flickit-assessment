...
public class RegenerateAllAssessmentInsightsRestController {
    ...
    private final RegenerateAllAssessmentInsightsUseCase useCase;
    private final UserContext userContext;

    @PutMapping("/assessments/{assessmentId}/regenerate-insights")
    public ResponseEntity<Void> regenerateAllAssessmentInsights(@PathVariable("assessmentId") UUID assessmentId) {
        UUID currentUserId = userContext.getUser().id();
        useCase.regenerateAllAssessmentInsights(toParam(assessmentId, currentUserId));
