...
import org.flickit.assessment.core.application.port.in.assessmentuserrole.GetAssessmentUserPermissionsUseCase.Result;
...
public class GetAssessmentUserPermissionsRestController {
    ...
    public ResponseEntity<Result> getAssessmentUserPermissions(@PathVariable("assessmentId") UUID assessmentId) {
