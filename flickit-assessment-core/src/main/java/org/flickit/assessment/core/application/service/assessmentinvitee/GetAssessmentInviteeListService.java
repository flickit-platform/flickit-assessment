...
import org.flickit.assessment.core.application.port.in.assessmentinvitee.GetAssessmentInviteeListUseCase.Result.Role;
...
public class GetAssessmentInviteeListService implements GetAssessmentInviteeListUseCase {
    ...
    private Result toResult(AssessmentInvitee invitee) {
