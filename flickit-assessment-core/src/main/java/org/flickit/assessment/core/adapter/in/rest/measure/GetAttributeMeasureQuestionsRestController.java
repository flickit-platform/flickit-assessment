...
public class GetAttributeMeasureQuestionsRestController {
    ...
    public ResponseEntity<GetAttributeMeasureQuestionsUseCase.Result> getQuestions(@PathVariable("assessmentId") UUID assessmentId,
                                                                                   @PathVariable("attributeId") Long attributeId,
                                                                                   @PathVariable("measureId") Long measureId) {
        UUID currentUserId = userContext.getUser().id();
        var result = useCase.getQuestions(toParam(assessmentId, attributeId, measureId, currentUserId));
