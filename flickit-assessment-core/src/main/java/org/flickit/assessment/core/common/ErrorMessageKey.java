...
public class ErrorMessageKey {
    ...
    public static final String GRANT_ASSESSMENT_USER_ROLE_USER_ID_AND_ASSESSMENT_ID_ALREADY_EXIST = "grant-assessment-user-role.userRoleUserIdAndAssessmentId.alreadyExist";
