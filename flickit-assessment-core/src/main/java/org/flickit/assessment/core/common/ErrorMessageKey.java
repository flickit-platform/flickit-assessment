...
public class ErrorMessageKey {
    ...
    public static final String ADD_EVIDENCE_EVIDENCE_TYPE_INVALID = "add-evidence.evidenceType.invalid";
    ...
    public static final String UPDATE_EVIDENCE_EVIDENCE_TYPE_ID_MIN = "update-evidence.evidenceTypeId.min";
    public static final String UPDATE_EVIDENCE_EVIDENCE_TYPE_ID_MAX = "update-evidence.evidenceTypeId.max";
