...
public class ErrorMessageKey {
    ...
    public static final String SUBMIT_ANSWER_CREATED_BY_NOT_NULL = "submit-answer.createdBy.notNull";
    public static final String SUBMIT_ANSWER_USER_NOT_FOUND = "submit-answer.user.notFound";
