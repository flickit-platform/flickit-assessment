...
public interface CountLowConfidenceAnswersPort {
     ...
     *
     * @param assessmentResultId the unique identifier of the assessment result
     * @param questionnaireIds the set of questionnaire IDs to filter the answers
     * @param confidence the confidence level threshold
     ...
     */
    Map<Long, Integer> countWithConfidenceLessThan(UUID assessmentResultId, Set<Long> questionnaireIds, ConfidenceLevel confidence);
}
