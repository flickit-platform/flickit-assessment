...
public interface PublishAssessmentReportUseCase {

    void publishAssessmentReport(Param param);

    @Value
    @EqualsAndHashCode(callSuper = false)
    class Param extends SelfValidating<Param> {

        @NotNull(message = PUBLISH_ASSESSMENT_REPORT_ASSESSMENT_ID_NOT_NULL)
        UUID assessmentId;
