...
class CreateAssessmentServiceTest {
    ...
    void testCreateAssessment_ValidParam_PersistsSubjectValues() {
        ...
        List<Subject> expectedSubjects = List.of(
            new Subject(2L, 2, "subject2", "subject2 description", 1, List.of(qa3, qa4)),
            new Subject(1L, 1, "subject1", "subject1 description", 1, List.of(qa1, qa2)),
            new Subject(3L, 3, "subject3", "subject3 description", 1, List.of(qa5))
        );
    ...
    void testCreateAssessment_ValidCommand_PersistsAttributeValue() {
        ...
        List<Subject> expectedSubjects = List.of(
            new Subject(1L,1, "subject2","subject2 description",  1, List.of(qa1, qa2)),
            new Subject(2L,2, "subject1","subject1 description",  1, List.of(qa3, qa4)),
            new Subject(3L,3, "subject3","subject3 description",  1, List.of(qa5))
        );
