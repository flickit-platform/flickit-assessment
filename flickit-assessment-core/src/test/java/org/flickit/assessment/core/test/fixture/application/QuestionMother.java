...
public class QuestionMother {
    ...
    public static Question withImpactsOnLevel23() {
        return new Question(id++, null, List.of(QuestionImpactMother.onLevelTwo(1), QuestionImpactMother.onLevelThree(1)));
    }

    public static Question withImpactsOnLevel24() {
        return new Question(id++, null, List.of(QuestionImpactMother.onLevelTwo(1), QuestionImpactMother.onLevelFour(1)));
    }

    public static Question withImpactsOnLevel34() {
        return new Question(id++, null, List.of(QuestionImpactMother.onLevelThree(1), QuestionImpactMother.onLevelFour(1)));
    }

    public static Question withImpactsOnLevel45() {
        return new Question(id++, null, List.of(QuestionImpactMother.onLevelFour(1), QuestionImpactMother.onLevelFive(1)));
    }
