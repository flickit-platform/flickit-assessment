...
public class ArchUnitTestConstants {
    ...
    public static final String HELPER_SERVICE = "(.*)(CreateAttributeAiInsightHelper|CreateSubjectInsightsHelper|CreateAssessmentInsightHelper|GetAssessmentInsightHelper|GetAttributeInsightHelper|GetSubjectInsightHelper|InitializeAssessmentResultHelper|CalculateAssessmentHelper|CalculateConfidenceHelper)";
}
