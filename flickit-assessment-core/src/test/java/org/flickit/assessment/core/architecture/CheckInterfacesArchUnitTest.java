...
public class CheckInterfacesArchUnitTest {
    ...
    @ArchTest
    static final ArchRule ports_and_useCases_must_be_interface =
        classes()
            .that()
            .areTopLevelClasses()
            .and()
    ...
    static final ArchRule interfaces_must_not_be_placed_in_implementation_packages =
        classes()
            .that()
            .resideInAnyPackage(APPLICATION_SERVICE, ADAPTER_OUT_PERSISTENCE)
            .and()
    ...
    @ArchTest
    static final ArchRule ports_and_useCases_must_have_one_implementation =
        classes()
            .that()
            .areTopLevelClasses()
            .and()
