...
class GetEvidenceAttachmentListUseCaseParamTest {

    @Test
    void testGetEvidenceAttachmentListParam_evidenceIsNull_ErrorMessage() {
        var currentUserId = UUID.randomUUID();
        var throwable = assertThrows(ConstraintViolationException.class,
            () -> new GetEvidenceAttachmentListUseCase.Param(null, currentUserId));
        assertThat(throwable).hasMessage("evidenceId: " + GET_EVIDENCE_ATTACHMENT_LIST_EVIDENCE_ID_NULL);
    }
    ...
    void testGetEvidenceAttachmentListParam_currentUserIdIsNull_ErrorMessage() {
        ...
        var throwable = assertThrows(ConstraintViolationException.class,
            () -> new GetEvidenceAttachmentListUseCase.Param(evidenceId,null));
