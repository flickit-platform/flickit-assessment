...
class CreateAdviceItemServiceTest {
    ...
    void testCreateAdviceItem_whenValidParameter_thenCreatesAdviceItemSuccessfully() {
        ...
        ArgumentCaptor<CreateAdviceItemPort.Param> argumentCaptor = ArgumentCaptor.forClass(CreateAdviceItemPort.Param.class);
        verify(createAdviceItemPort).persist(argumentCaptor.capture(), eq(assessmentResult.getId()));
