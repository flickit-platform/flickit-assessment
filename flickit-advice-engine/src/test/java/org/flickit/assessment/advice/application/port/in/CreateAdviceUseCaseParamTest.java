...
class CreateAdviceUseCaseParamTest {
    ...
    void testCreateAdviceParam_AssessmentIdIsNull_ErrorMessage() {
        ...
        List<AdviceQuestion> adviceListItems = List.of(new AdviceQuestion(null, null, null));
        UUID currentUserId = UUID.randomUUID();

        var throwable = assertThrows(ConstraintViolationException.class,
            () -> new CreateAdviceUseCase.Param(null, attributeLevelTargets, adviceListItems, currentUserId));
    ...
    void testCreateAdviceParam_AttributeLevelTargetsIsNull_ErrorMessage() {
        ...
        var throwable = assertThrows(ConstraintViolationException.class,
            () -> new CreateAdviceUseCase.Param(assessmentId, null, adviceListItems, currentUserId));
    ...
    void testCreateAdviceParam_AttributeLevelTargetsIsLessThanMin_ErrorMessage() {
        ...
        var throwable = assertThrows(ConstraintViolationException.class,
            () -> new CreateAdviceUseCase.Param(assessmentId, attributeLevelTargets, adviceListItems, currentUserId));
    ...
    void testCreateAdviceParam_CurrentUserIdIsNull_ErrorMessage() {
        ...
        var throwable = assertThrows(ConstraintViolationException.class,
            () -> new CreateAdviceUseCase.Param(assessmentId, attributeLevelTargets, adviceListItems, null));
