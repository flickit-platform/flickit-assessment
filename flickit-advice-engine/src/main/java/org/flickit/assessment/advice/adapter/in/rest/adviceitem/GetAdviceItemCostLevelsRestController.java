...
import org.flickit.assessment.advice.application.port.in.adviceitem.GetAdviceItemCostLevelUseCase.Result;
...
public class GetAdviceItemCostLevelsRestController {
    ...
    private final GetAdviceItemCostLevelUseCase useCase;
