...
public class RefreshAssessmentAdviceService implements RefreshAssessmentAdviceUseCase {
    ...
    public void refreshAssessmentAdvice(Param param) {
        ...
        var attributes = loadAttributesPort.loadAll(param.getAssessmentId(), assessmentResult.getKitVersionId(), assessmentResult.getLanguage());
        var maturityLevels = loadMaturityLevelsPort.loadAll(param.getAssessmentId());
