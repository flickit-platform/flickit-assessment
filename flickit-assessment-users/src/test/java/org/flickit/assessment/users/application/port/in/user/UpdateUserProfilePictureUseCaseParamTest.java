...
class UpdateUserProfilePictureUseCaseParamTest {
    ...
    @Test
    void testUpdateUserProfilePictureParam_pictureIsNull_ErrorMessage() {
        UUID currentUserId = UUID.randomUUID();
        var throwable = assertThrows(ConstraintViolationException.class,
            () -> new UpdateUserProfilePictureUseCase.Param(currentUserId, null));
        assertThat(throwable).hasMessage("picture: " + UPDATE_USER_PROFILE_PICTURE_PICTURE_NOT_NULL);
    }

    @Test
    void testUpdateUserProfilePictureParam_pictureIsEmpty_ErrorMessage() throws IOException {
        UUID currentUserId = UUID.randomUUID();
    ...
    @Test
    void testUpdateUserProfilePictureParam_currentUserIdIsNull_ErrorMessage() throws IOException {
        MockMultipartFile picture = new MockMultipartFile("images", "image1",
