...
class GetSpaceListServiceTest {
    ...
    void testGetSpaceList_validInputs_validResults() {
        ...
        assertEquals(SpaceType.BASIC.getCode(), result.getItems().getFirst().type().getCode());
        assertEquals(SpaceType.BASIC.getTitle(), result.getItems().getFirst().type().getTitle());
        ...
        assertEquals(SpaceType.PREMIUM.getCode(), result.getItems().get(1).type().getCode());
        assertEquals(SpaceType.PREMIUM.getTitle(), result.getItems().get(1).type().getTitle());
    }
