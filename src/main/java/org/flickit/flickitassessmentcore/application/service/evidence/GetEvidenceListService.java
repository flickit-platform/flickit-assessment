...
public class GetEvidenceListService implements GetEvidenceListUseCase {
    ...
    public Result getEvidenceList(Param param) {
        return new Result(loadEvidencesByQuestion.loadEvidencesByQuestionId(
            new LoadEvidencesByQuestionPort.Param(param.getQuestionId()), param.getPage(), param.getSize()).evidences());
    }
}
