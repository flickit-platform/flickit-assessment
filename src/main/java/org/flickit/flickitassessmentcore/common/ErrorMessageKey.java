...
public class ErrorMessageKey {
    ...
    public static final String GET_ASSESSMENT_SPACE_ID_ASSESSMENT_ID_NOT_NULL = "get-assessment-space-id.assessmentId.notNull";
    public static final String GET_ASSESSMENT_SPACE_ID_ASSESSMENT_ID_NOT_FOUND = "get-assessment-space-id.assessmentId.notFound";
}
