...
class RemoveAssessmentServiceTest {
    ...
    public void testRemoveAssessment() {
        ...
        doNothing().when(deleteAssessmentPort).softDeleteAndSetDeletionTimeById(any());
        ...
        verify(deleteAssessmentPort).softDeleteAndSetDeletionTimeById(portParam.capture());
        ...
        verify(deleteAssessmentPort, times(1)).softDeleteAndSetDeletionTimeById(any());
    }
}
