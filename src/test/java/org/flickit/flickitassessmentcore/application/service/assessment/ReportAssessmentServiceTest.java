...
import static org.flickit.flickitassessmentcore.application.domain.mother.QualityAttributeValueMother.*;
...
class ReportAssessmentServiceTest {
    ...
    void reportAssessment_ValidResult() {
        List<QualityAttributeValue> qaValues = List.of(
            calcAsLevelOneWithAttribute(QualityAttributeMother.simple()),
            calcAsLevelTwoWithAttribute(QualityAttributeMother.simple()),
            calcAsLevelThreeWithAttribute(QualityAttributeMother.simple()),
            calcAsLevelFourWithAttribute(QualityAttributeMother.simple()),
            calcAsLevelFiveWithAttribute(QualityAttributeMother.simple())
        );
