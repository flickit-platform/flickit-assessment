...
public class OpenAiProperties {
    ...
    private String aiAdviceNarrationPrompt = """
        ...
        Task: Based on the provided advice items, generate a clear narrative with up to 10 concise bullet points, but include only as many points as there are distinct pieces of actionable advice, skipping redundant or trivial suggestions. Consider using the title of the assessment in your response.
