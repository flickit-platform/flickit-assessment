...
public record MaturityLevelTranslation(
    @Size(min = 3, message = TRANSLATION_MATURITY_LEVEL_TITLE_SIZE_MIN)
    @Size(max = 100, message = TRANSLATION_MATURITY_LEVEL_TITLE_SIZE_MAX)
    String title,

    @Size(min = 3, message = TRANSLATION_MATURITY_LEVEL_DESCRIPTION_SIZE_MIN)
