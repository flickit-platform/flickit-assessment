...
public interface UpdateKitCustomUseCase {
    ...
    void updateKitCustom(Param param);
    ...
    class Param extends SelfValidating<Param> {
        ...
        @NotNull(message = UPDATE_KIT_CUSTOM_TITLE_NOT_NULL)
        @Size(min = 3, message = UPDATE_KIT_CUSTOM_TITLE_SIZE_MIN)
        @Size(max = 100, message = UPDATE_KIT_CUSTOM_TITLE_SIZE_MAX)
        String title;

        @NotNull(message = UPDATE_KIT_CUSTOM_DATA_NOT_NULL)
        ...
        @Builder
        public Param(Long kitCustomId, Long kitId, String title, KitCustomData customData, UUID currentUserId) {
        ...
        public record KitCustomData(List<CustomSubject> customSubjects, List<CustomAttribute> customAttributes) {
            ...
            public KitCustomData {
                if (customSubjects.isEmpty() && customAttributes.isEmpty())
                    throw new ValidationException(UPDATE_KIT_CUSTOM_EMPTY_CUSTOM_NOT_ALLOWED);
            }
            ...
            public static class CustomSubject extends SelfValidating<CustomSubject> {
                ...
                @NotNull(message = UPDATE_KIT_CUSTOM_SUBJECT_ID_NOT_NULL)
                Long id;

                @NotNull(message = UPDATE_KIT_CUSTOM_SUBJECT_WEIGHT_NOT_NULL)
                Integer weight;
            ...
            public static class CustomAttribute extends SelfValidating<CustomAttribute> {
                ...
                @NotNull(message = UPDATE_KIT_CUSTOM_ATTRIBUTE_ID_NOT_NULL)
                Long id;

                @NotNull(message = UPDATE_KIT_CUSTOM_ATTRIBUTE_WEIGHT_NOT_NULL)
                Integer weight;
