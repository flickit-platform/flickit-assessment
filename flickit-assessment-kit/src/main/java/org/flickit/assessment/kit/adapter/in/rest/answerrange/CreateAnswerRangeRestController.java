...
public class CreateAnswerRangeRestController {
    ...
    public ResponseEntity<Void> crateAnswerRange(@PathVariable("kitVersionId") Long kitVersionId,
                                                 @RequestBody CreateAnswerRangeRequestDto requestDto) {
        UUID currentUserId = userContext.getUser().id();
        useCase.createAnswerRange(toParam(kitVersionId, currentUserId, requestDto));
