...
public class QuestionUpdateKitPersister implements UpdateKitPersister {
    ...
    public UpdateKitPersisterResult persist(UpdateKitPersisterContext ctx,
        ...
        newQuestionnaireCodes.forEach(code -> createNewQuestions(dslQuestionnaireToQuestionsMap.get(code),
    ...
    private boolean createNewQuestions(Map<String, Map<String, Question>> savedQuestionnaireToQuestionsMap,
        ...
        for (Map.Entry<String, Map<String, Question>> questionnaire : savedQuestionnaireToQuestionsMap.entrySet()) {
            ...
            createNewQuestions(newDslQuestionsMap, postUpdateQuestionnaires, postUpdateAttributes, postUpdateMaturityLevels, currentUserId);
    ...
    private void createNewQuestions(Map<String, QuestionDslModel> dslQuestions,
