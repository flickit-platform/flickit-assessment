...
import org.flickit.assessment.kit.application.port.in.kitcustom.GetKitCustomSubjectUseCase.Result;
...
public class GetKitCustomSubjectRestController {
    ...
    public ResponseEntity<PaginatedResponse<Result>> getKitCustomSubject(@PathVariable("kitId") Long kitId,
