...
class CreateAnswerRangeOptionUseCaseParamTest {
    ...
    @Test
    void testCreateAnswerRangeOptionUseCaseParam_translationsLanguageViolations_ErrorMessage() {
    ...
    @Test
    void testCreateAnswerRangeOptionUseCaseParam_translationsFieldsViolations_ErrorMessage() {
        var throwable = assertThrows(ConstraintViolationException.class,
