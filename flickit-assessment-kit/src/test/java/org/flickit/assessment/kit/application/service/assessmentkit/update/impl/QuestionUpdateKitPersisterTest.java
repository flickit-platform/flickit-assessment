...
class QuestionUpdateKitPersisterTest {
    ...
    void testQuestionUpdateKitPersister_SameInputsAsDatabaseData_NoChange() {
        ...
        var savedQuestion = QuestionMother.createQuestion(QUESTION_CODE1, QUESTION_TITLE1, 1, null, Boolean.FALSE, savedQuestionnaire.getId());
    ...
    void testQuestionUpdateKitPersister_QuestionImpactDeleted_DeleteFromDatabase() {
        ...
        var savedOptionImpact4 = AnswerOptionImpactMother.createAnswerOptionImpact(answerOption2.getId(), 0.75);
