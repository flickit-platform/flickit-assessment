...
import static org.flickit.assessment.kit.common.ErrorMessageKey.GET_QUESTIONNAIRE_KIT_ID_NOT_NULL;
import static org.flickit.assessment.kit.common.ErrorMessageKey.GET_QUESTIONNAIRE_QUESTIONNAIRE_ID_NOT_NULL;
...
class GetKitQuestionnaireDetailUseCaseTest {
    ...
    void testGetKitQuestionnaireDetail_KitIdIsNull_ErrorMessage() {
        ...
        assertThat(throwable).hasMessage("kitId: " + GET_QUESTIONNAIRE_KIT_ID_NOT_NULL);
    }
    ...
    void testGetKitQuestionnaireDetail_QuestionnaireIdIsNull_ErrorMessage() {
        ...
        assertThat(throwable).hasMessage("questionnaireId: " + GET_QUESTIONNAIRE_QUESTIONNAIRE_ID_NOT_NULL);
    }
