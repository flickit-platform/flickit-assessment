...
class QuestionUpdateKitValidatorTest {
    ...
    void testValidator_SameQuestionsInDbAndDsl_Valid() {
        var questionOne = QuestionMother.createQuestion(QUESTION_CODE1, QUESTION_TITLE1, 1, "", Boolean.FALSE, 1, 1L);
        var questionTwo = QuestionMother.createQuestion(QUESTION_CODE2, QUESTION_TITLE2, 2, "", Boolean.FALSE, 1, 1L);
