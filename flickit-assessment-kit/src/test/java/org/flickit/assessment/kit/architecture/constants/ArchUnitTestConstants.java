...
public class ArchUnitTestConstants {
    ...
    // Full Package
    public static final String ADAPTER_FULL_PACKAGE = "org.flickit.assessment.kit.adapter";
    public static final String APPLICATION_PORT_IN_FULL_PACKAGE = "org.flickit.assessment.kit.application.port.in";
    public static final String APPLICATION_PORT_OUT_FULL_PACKAGE = "org.flickit.assessment.kit.application.port.out";
    public static final String APPLICATION_PORT_FULL_PACKAGE = "org.flickit.assessment.kit.application.port";
    public static final String APPLICATION_SERVICE_FULL_PACKAGE = "org.flickit.assessment.kit.application.service";
    public static final String APPLICATION_DOMAIN_FULL_PACKAGE = "org.flickit.assessment.kit.application.domain";
    public static final String ADAPTER_IN_REST_FULL_PACKAGE = "org.flickit.assessment.kit.adapter.in.rest";
    public static final String APPLICATION_FULL_PACKAGE = "org.flickit.assessment.kit.application";
    ...
    public static final String APPLICATION = "..assessment.kit.application..";
